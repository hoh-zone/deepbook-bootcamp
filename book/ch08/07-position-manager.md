...
- 理解 `position_manager` 管的是 MarginPool 供应者份额，不是交易多空仓位。
- 能说明 `SupplierCap`、supply shares、referral 如何一起记录供应者权益。
- 能把供应者可提金额与 `margin_state.supply_shares_to_amount` 联系起来。
